            ...
            <div class="col-sm-12">
                <section class="panel">
                    <table class="table responsive-data-table data-table">
                        ...
                        <tbody>
                        <c:forEach items="${activityItemList}" var="arr" varStatus="status">
                        <tr>
                            ...
                            <td>${arr.count}</td>
                            <td>
                                <button type="button" onclick="openData('${arr.activityId}','${arr.itemId}')" class="btn btn-sm btn-info">详情</button>
                            </td>
                        </tr>
                        </c:forEach>
                        </tbody>
...
<script type="text/javascript">
    ...
    function openData(activityId, itemId) {
        window.open("/games/publics/enter/publish-data?activityId="+activityId+"&itemId="+itemId, "publish-data");
    }
